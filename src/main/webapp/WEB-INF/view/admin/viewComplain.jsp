					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">
								<h4 class="box-title">View Complain Table</h4>
							...
							<div class="box-body">
								<div class="table-responsive">
									<table id="example"
										...
										<tbody>
										<c:forEach items="${complainSearchList}" var="i">
											<tr>
												<td>${i.id}</td>
												<td>${i.complainSubject}</td>
												<td>${i.complainDesription}</td>
												<td>${i.complainStatus}</td>
												<td>${i.complainFileName}</td>
												<c:if test="${i.complainStatus eq 'pending'}">
												<td><a href="/admin/replyComplain?id=${i.id}">Reply</a></td>
												</c:if>
