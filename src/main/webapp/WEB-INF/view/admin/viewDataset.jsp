					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">
								<h4 class="box-title">View Dataset Table</h4>
							...
							<div class="box-body">
								<div class="table-responsive">
									<table id="example" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
										...
										<tbody>
										<c:forEach items="${viewDataset}" var="i">
											...
											<tr>
												...
												<td>${i.dataset}</td>
												<td>${i.filedesc}</td>
												<td><a href="editViewData?id=${i.id}">Edit</a> <br> <a href="deleteViewData?id=${i.id}">Delete</a></td>
											</tr>
										</c:forEach>
										</tbody>
