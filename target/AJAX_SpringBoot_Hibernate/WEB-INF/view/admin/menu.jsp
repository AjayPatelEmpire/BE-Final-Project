...
<!--             <li><a href="index2.html"><i class="mdi mdi-resize-bottom-right"></i>Dashboard 2</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<%request.getContextPath(); %>/admin/loadWorker"><i class="mdi mdi-resize-bottom-right"></i>Add Worker</a></li>
            <li><a href="<%request.getContextPath(); %>/admin/viewWorker"><i class="mdi mdi-resize-bottom-right"></i>View Worker</a></li>
<!--             <li><a href="collapsed-sidebar.html"><i class="mdi mdi-resize-bottom-right"></i>Mini Sidebar</a></li> -->
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			<li><a href="<%request.getContextPath(); %><%request.getContextPath(); %>/admin/addDataset"><i class="mdi mdi-resize-bottom-right"></i>Add Dataset</a></li>
			<li><a href="<%request.getContextPath(); %>/admin/viewDataset"><i class="mdi mdi-resize-bottom-right"></i>View Dataset</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
  			<li><a href="<%request.getContextPath(); %>/admin/addAttendance"><i class="mdi mdi-resize-bottom-right"></i>Add Attendance</a></li>
			<li><a href="<%request.getContextPath(); %>/admin/viewAttendance"><i class="mdi mdi-resize-bottom-right"></i>View Attendance</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<%request.getContextPath(); %>/admin/viewReport"><i class="mdi mdi-resize-bottom-right"></i>View Reports</a></li>			
          </ul>
        </li>		
		<li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
			<li><a href="<%request.getContextPath(); %>/admin/viewComplain"><i class="mdi mdi-resize-bottom-right"></i>View Complain</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            			<li><a href="<%request.getContextPath(); %>/admin/viewFeedback"><i class="mdi mdi-resize-bottom-right"></i>View Feedback</a></li>
          </ul>
        </li>
