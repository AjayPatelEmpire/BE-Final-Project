			...
			<div class="row">
				<div class="col-lg-8 col-12">
					...
					<div class="box">
						...
						<div class="box-body">
							<div class="d-md-flex d-block align-items-center justify-content-between px-15">
								<div>
									<label>Users</label>
				...
				<div class="col-lg-4 col-12">
					...
					<div class="box bg-img box-inverse pull-up" style="background-: url(/adminResources/10.jpg);" data-overlay="7">				
						<div class="box-header with-border">
          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="/adminResources/avatar/1.jpg" alt="...">
			  </a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="/adminResources/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="/adminResources/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="/adminResources/4.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="/adminResources/1.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
				  <a class="hover-primary" href="#"><strong>Tyler</strong></a>
